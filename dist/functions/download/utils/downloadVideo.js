...
export const downloadVideo = async ({ url, interaction, videoFileName, outputPath, outputFileName, videoInfo, audioPath, onProgress }) => {
    try {
        ...
        if (fs.existsSync(videoPath))
            await deleteContent(videoPath);
        if (fs.existsSync(audioPath))
            await deleteContent(audioPath);
        await interaction.editReply({
