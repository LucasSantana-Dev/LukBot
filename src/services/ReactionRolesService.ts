...
export class ReactionRolesService {
    ...
    async deleteReactionRoleMessage(
        ...
        try {
            ...
            const message = await (prisma.reactionRoleMessage.findUnique as (args: unknown) => Promise<MessageWithMappings | null>)({
                where: { messageId },
            ...
            await (prisma.reactionRoleMessage.delete as (args: unknown) => Promise<unknown>)({
                where: { messageId },
            })
    ...
    async listReactionRoleMessages(guildId: string): Promise<Array<{
        id: string
        messageId: string
        channelId: string
        guildId: string
        ...
        try {
            ...
            const result = await (prisma.reactionRoleMessage.findMany as (args: unknown) => Promise<MessageWithMappings[]>)({
                where: { guildId },
                include: { mappings: true },
