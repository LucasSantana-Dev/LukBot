# Lucky Agent Commands (Workflows)
...
Use **prisma-redis-lucky** skill when changing schema or migrations.
...
- Data: `.cursor/rules/subagent-data.mdc` + **prisma-redis-lucky** skill
